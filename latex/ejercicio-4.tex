...
\begin{center}
    ...
    \end{tikzpicture}
\end{center}
Los graficos ponen en evidencia la paridad en terminos de ejecución temporal de ambas variantes. Si bien existe una minima diferencia en favor del Goloso, no es suficiente para concluir que esta es la mejor en terminos de ejecución temporal.
\begin{itemize}
