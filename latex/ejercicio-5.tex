\textit{Diseñar e implementar un algoritmo para CIDM que use la meta-heurística GRASP.}
...
Primero, vamos a comparar de a cuatro versiones a la vez (todas al mismo tiempo es mas difícil de ver la diferencia).
