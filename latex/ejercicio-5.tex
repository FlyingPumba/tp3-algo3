...
\begin{enumerate}
    \item Se utilizo para la primera solución Random el mismo método ConstruirGreedyRandom que se utiliza al generar una solución golosa randomizada.
    ...
    \item La función BusquedaLocal es identica al algoritmo implementado para el Ejercicio 4. En la experimentación se probo con los distintos criterios de vecindad expuestos en ese mismo Ejercicio.
...
\begin{enumerate}
    \item Criterio: realizar $n$ iteraciones, con $n$ la cantidad de nodos del grafo.
    \item Criterio: realizar $f(n)$ iteraciones, con $n$ la cantidad de nodos del grafo y siendo $f(n)=n^2$.
\end{enumerate}
